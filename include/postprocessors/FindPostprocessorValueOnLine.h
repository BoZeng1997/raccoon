 ...
 */
class FindPostprocessorValueOnLine : public GeneralPostprocessor, public Coupleable
{
public:
  static InputParameters validParams();

  FindPostprocessorValueOnLine(const InputParameters & parameters);
...
protected:
  ...
  /// Postprocessor value to find along the line
  const PostprocessorValue & _target;
